    ...
    const handleAnalyze = async () => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:3001/api/prescriptions/upload/${id}`,
                formData,
                    ...
                    <div className="space-y-6">
                        {isAnalyzing && (
                            <div className="bg-white shadow-xl rounded-2xl p-6 text-center">
                                <h3 className="text-xl font-semibold text-gray-900 mb-4">Analyzing...</h3>
                                <p className="text-lg font-semibold text-purple-700">AI is analyzing the image, please wait.</p>
                                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-purple-500 mx-auto mt-4"></div>
                            </div>
                        )}
